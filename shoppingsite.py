...
def list_melons():
    ...
    melon_list = melons.get_all() #instances of all the melon classes
    return render_template("all_melons.html",
                           melon_list=melon_list)


@app.route("/melon/<melon_id>") #a variable route
#if you go to /melon/alib, show_melon will be called with alib as the parameter
def show_melon(melon_id):#the melon id comes from the url
    """Return page showing the details of a given melon.

    Show all info about a melon. Also, provide a button to buy that melon.
    """

    melon = melons.get_by_id(melon_id) #can pass in the melon id from the paramateres because it comes
    #from the parameters
    print(melon)
...
def show_shopping_cart():
    ...
    #session['cart' {melon_id: num of times it was added}]
...
def add_to_cart(melon_id):
    ...
    #     cart[melon_id] = 0        these lines are also doing what the line about is doing
